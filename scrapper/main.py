...
for team in teams:
    try:
        ...
        draws = ranking_row[6].contents[0] # Matchs nuls
        ...
        team_data = {'club': team_club, 'equipe': squad, 'id_club': club_id, 'lien_equipe': team_link, 'classement': ranking, 'points': points, 'matchs_joues': games_played, 'matchs_gagnes': won_games, 'matchs_perdus': lost_games, 'matchs_nuls': draws, 'difference': difference, 'rencontres': fixtures_data}
